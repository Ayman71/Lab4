...
public class InventorySystemExtendedTest {
    ...
    public static double testProductManagement() {
        ...
        try {
            ...
            // Adding Product Test
            employee.addProduct("P001", "Laptop", "Apple", "TechSupplier", 10, (float)2000);
            ...
            employee.addProduct("P001", "Laptop", "Apple", "TechSupplier", 10, (float) 1000.0);
            if (employee.getListOfProducts().length == 1) {
    ...
    public static double testPurchaseManagement() {
        ...
        try {
            ...
            employee.addProduct("P002", "Mouse", "Logitech", "TechSupplier", 1, (float) 2000.0);
            ...
            if (purchased && ((Product)employee.getListOfProducts()[1]).getQuantity() == 0 &&
    ...
    public static double testReturnAndPaymentManagement() {
        ...
        try {
            ...
            employee.addProduct("P003", "Keyboard", "Logitech", "TechSupplier", 5, (float) 1000.0);
            ...
            if (refund != -1 && ((Product)employee.getListOfProducts()[2]).getQuantity() == 5) {
